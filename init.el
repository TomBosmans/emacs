...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (yaml-mode web-mode coffee-mode projectile solarized-theme))))
(custom-set-faces
...
;; Coffee mode: set tab of 2 spaces

; autosave files in tmp dir
(setq auto-save-file-name-transforms `((".*" ,temporary-file-directory t)))

;; PJasper can't think of a single time this has helped him, so we trust him.
